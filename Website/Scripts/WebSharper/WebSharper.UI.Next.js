(function()
{
 ...
 Doc.LoadLocalTemplates=function(baseName)
 {
  ...
  existingLocalTpl.count>0?Docs$1.LoadedTemplates().set_Item(baseName,existingLocalTpl):(function()
  {
   ...
   while(true)
    {
     m=self.document.querySelector("[ws-template]");
     if(Unchecked.Equals(m,null))
      {
       m$1=self.document.querySelector("[ws-children-template]");
 ...
 SC$9.$cctor=function()
 {
  ...
  SC$9.ActivateButtonListener=!Input.MouseBtnSt$1().Active?(Input.MouseBtnSt$1().Active=true,self.document.addEventListener("mousedown",function(evt)
  {
  ...
  SC$9.ActivateKeyListener=!Input.KeyListenerState().KeyListenerActive?($(self.document).keydown(function(evt)
  {
   var keyCode,xs;
   keyCode=evt.which;
